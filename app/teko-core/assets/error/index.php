...
<head>
    ...
    <title><?= $titulo ?></title>
    <link rel="shortcut icon" href="<?php echo site_url('app/teko-core/assets/favicon.ico');
?>">
    <meta content="Teko Admin" name="description" />
    <meta content="Teko Estudio" name="author" />
    <link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet" type="text/css"/>
    <link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:400,900" rel="stylesheet"> 
    <link href="<?php echo site_url('app/teko-core/assets/error/css/style.css');
...
<script type="text/javascript" src="<?php echo site_url('app/teko-core/assets/error/js/plugins.min.js'); ?>"></script>
<script type="text/javascript" src="<?php echo site_url('app/teko-core/assets/error/js/actions.js'); ?>"></script>
</body>
</html>